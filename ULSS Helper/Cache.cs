...
public class Cache
{
    ...
    public List<AutoCase> GetCasess()
    {
    ...
    public void RemoveProcess(ulong messageId)
    {
    ...
    public void SaveUserAction(ulong userId, string actionId, UserActionCache newCache)
    {
    ...
    public UserActionCache GetUserAction(ulong userId, string actionId)
    {
    ...
    public async Task RemoveExpiredCacheEntries(TimeSpan maxCacheAge)
    {
